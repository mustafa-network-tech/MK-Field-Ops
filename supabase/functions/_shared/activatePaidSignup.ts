...
export type ActivatePaidSignupParams = {
...
export type ActivatePaidSignupResult =
  | { ok: true; alreadyCompleted: true; companyId: string; userId: string }
  | { ok: true; alreadyCompleted: false; companyId: string; userId: string }
...
export async function activatePaidSignup(
  ...
  params: ActivatePaidSignupParams,
): Promise<ActivatePaidSignupResult> {
