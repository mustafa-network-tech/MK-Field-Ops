...
import { upsertTeam } from '@/lib/supabase/supabaseSyncService';
import { addTeam, updateTeam, getEligibleTeamLeaders, wipeTeam } from '@/features/teams/services/teamService';
import { getTeamsForUser } from '@/features/teams/services/teamScopeService';
import { canPlanAddTeam } from '@/lib/permissions/planGating';
import { getEffectivePlan } from '@/features/companies/services/subscriptionService';
import { logEvent, actorFromUser } from '@/features/settings/services/auditLogService';
import { addActivityNotification } from '@/shared/services/activityNotificationService';
import { Card } from '@/shared/components/ui/Card';
import type { Team, TeamManualMember } from '@/shared/types';
import styles from '@/shared/components/management/ManagementTabs.module.css';
