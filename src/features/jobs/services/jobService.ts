...
} from '@/lib/supabase/supabaseSyncService';
import { canUserUseTeamForJob } from '@/features/teams/services/teamScopeService';
...
import type { User, JobRecord, JobMaterialUsage, TeamMaterialAllocation } from '@/shared/types';
