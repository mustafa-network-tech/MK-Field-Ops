...
import { getApprovedJobsWithDetailsForUser } from '@/features/jobs/services/jobCalculationService';
...
import { getActivePeriod } from '@/shared/utils/periodUtils';
import { isDateInPeriod } from '@/shared/utils/periodUtils';
import { getLocalTodayString, getLocalWeekRange, getLocalMonthString } from '@/shared/utils/localDateUtils';
