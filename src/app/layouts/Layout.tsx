...
import { updateCompanyLanguageInSupabase } from '@/features/companies/services/companyService';
import { pushCompanyDataToSupabase } from '@/lib/supabase/supabaseSyncService';
import { canPlanAccessFeature } from '@/lib/permissions/planGating';
import { getSubscriptionState, getEffectivePlan } from '@/features/companies/services/subscriptionService';
import { getPendingApprovalsCountForUser } from '@/features/approvals/services/approvalNotificationService';
import { useManagementNotificationCount } from '@/features/companies/hooks/useManagementNotificationCount';
import type { CompanyLanguageCode } from '@/shared/types';
