...
export const store = {
  ...
  updateCompany(companyId: string, patch: Partial<Pick<Company, 'name' | 'logo_url' | 'language_code' | 'plan' | 'plan_start_date' | 'plan_end_date' | 'pending_plan' | 'pending_plan_billing_cycle' | 'subscription_status' | 'closure_requested_at' | 'purge_after' | 'closed_by_user_id' | 'max_users_override' | 'usage_period_days' | 'usage_period_started_at'>>, onlyForCompanyId?: string): Company | undefined {
